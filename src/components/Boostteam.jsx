...
import Frame3 from '../assets/Frame (9).svg'
        ...
        <div className="flex flex-col lg:ml-70 lg:flex-row items-center lg:items-start px-4 lg:px-0">
            ...
            <div className="w-72 sm:w-96 lg:ml-80 h-72 sm:h-96 relative mt-12 lg:mt-[80px] mx-auto lg:ml-12" data-aos="fade-up" data-aos-delay="800">
                ...
                <div className="w-full h-full rounded-full border border-[#291F3D] relative flex items-center justify-center">
                    ...
                    {/* Middle Circle */}
                    <div className="w-2/3 h-2/3 rounded-full border border-[#291F3D] flex items-center justify-center relative">
                        ...
                        {/* Inner Central Icon */}
                        <div className="w-1/3 h-1/3 rounded-full border border-[#291F3D] flex items-center justify-center relative">
                            <div className="w-2/3 h-2/3 rounded-full flex items-center justify-center">
                                <img src={Frame} alt="icon" className="w-9 lg:h-14 lg:w-14 lg:rounded-full sm:w-16 h-9 sm:h-16 rounded-full" style={{
                                    boxShadow: `0 0 50px #423260, 0 0 50px #423260, 0 0 60px #423260, 0 0 80px #423260, 0 0 100px #423260`
                                }} />
                            </div>
                        </div>
