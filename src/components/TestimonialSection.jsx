    ...
    return (
        <section className="text-white py-20 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                {/* Cards */}
                <div className="flex flex-col sm:flex-row justify-center items-center gap-6 transition-all duration-500">
                    {testimonials.map((item, index) => {
                        const isActive = index === current;
                        ...
                        return (
                            <div
                                key={item.id}
                                className={`w-full sm:w-80 p-6 rounded-2xl transition-all duration-500
                                    ${isActive
                                        ? "bg-gradient-to-br from-purple-700/40 to-purple-900/40 scale-105 border border-purple-500"
                                        : "bg-gray-900 opacity-40 scale-95"
                                    }`}
                ...
                {/* Bottom Section */}
                <div className="flex flex-col sm:flex-row justify-between items-center mt-12 gap-4 sm:gap-0">
