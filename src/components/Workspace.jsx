...
function Workspace() {
    return (
        ...
        <div className="flex flex-col lg:ml-60 lg:flex-row items-center lg:items-start px-4 lg:px-0 lg:mt-5">
            {/* Left Image Section */}
            <div className="w-full sm:w-3/4 lg:w-[504px] mt-6 lg:mt-[50px] mx-auto lg:mx-0">
            ...
            <div className="w-full lg:w-1/2 lg:ml-90 mt-8 lg:mt-[120px] text-center lg:text-left px-4 lg:px-0">
                ...
                <div className="mt-6 sm:mt-8 text-white/50 text-base sm:text-[19px] space-y-1 lg:space-y-0">
